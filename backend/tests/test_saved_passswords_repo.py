...
def test_list_by_user(password_repo):
    ...
    password_repo.create(wrong_user_id, "encrypted3", "salt3", "nonce3", "desc3", {}, "p3")
...
def test_update_description(password_repo):
    ...
    result = password_repo.update_description(created.id, user_id=wrong_user, new_description="hack")
