...
from backend.app.core.constants import PBKDF2_ITERATIONS,KEY_LENGTH_BYTES,SALT_LENGTH_BYTES,NONCE_LENGTH_BYTES
from backend.app.models.encrypted_password import EncryptedPassword
...
class PasswordEncryptionService:
    ...
    def _derive_key(self, salt:bytes)->bytes:
        kdf=PBKDF2HMAC(algorithm=hashes.SHA256(),length=KEY_LENGTH_BYTES,salt=salt,iterations=PBKDF2_ITERATIONS,backend=default_backend())
